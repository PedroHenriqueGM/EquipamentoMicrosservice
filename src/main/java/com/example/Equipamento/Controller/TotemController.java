...
import com.example.Equipamento.Dto.BicicletaDTO; 
...
public class TotemController {
    ...
    public ResponseEntity<List<BicicletaDTO>> listarBicicletasDoTotem(@PathVariable Long idTotem) {
        List<BicicletaDTO> bicicletas = bicicletaService.listarBicicletasDoTotem(idTotem);
